...
import './css/App.css';
import UusiLipputyyppi from "./components/UusiLipputyyppi";
        ...
        <Router>
            <Routes>
                ...
                <Route path="/tapahtumat/uusi"
                    element={
                        <PrivateLayout header="Luo uusi tapahtuma">
                            <PrivateRoute>
                                <UusiTapahtuma />
                            </PrivateRoute>
                        </PrivateLayout>
                ...
                />
                <Route path="/lipputyypit/uusi"
                    element={
                        <PrivateLayout header="Luo uusi lipputyyppi">
                            <PrivateRoute>
                                <UusiLipputyyppi />
                            </PrivateRoute>
                        </PrivateLayout>
